...
export class VentaComponent implements OnInit {
  ...
  getConsecutivo() {
    this.clientehttp.get(this.apiURL + "venta/consecutivo").subscribe((data) => {
  ...
  clientedata: any;
  getCliente() {
    this.clientehttp.get(this.apiURL + "cliente/" + this.cedulacliente).subscribe((data) => {
  ...
  postVenta() {
    ...
    this.clientehttp.post(this.apiURL + "venta",
      {
...
*/
  ...
  postConsolidado() {
    console.log('Ingresando a Consolidado')
